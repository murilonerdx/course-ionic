...
public class DbService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Murilo Silva", "mu-silva@outlook.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));

        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Coelho galactico", "coelho-galactico@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
